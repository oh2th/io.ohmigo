...
module.exports = class ohmOnWifi {
   ...
   *
   * @returns {Object} Device info: deviceName, deviceID, deviceIP, firmware, uptime, temp, rout, type, type_name
   */
  async getInfo() {
    try {
      ...
      // Iterate over expected properties and set them to null if missing
      expectedProperties.forEach((property) => {
        if (!(property in result.data)) {
